...
public class LabirintoBuilderTest {
	...
	@Test
	public void testListaStanze() {
		Labirinto labirinto=labirintoBuilder
				.addStanzaIniziale(nomeStanzaIniziale)
				.addStanzaVincente(nomeStanzaVincente)
				.addStanza("mensa").addMago("Mago", "mi presento", "clava", 1)
				.addStanza("corridoio")
				.getLabirinto();
		assertEquals(new Mago("Mago", "mi presento", new Attrezzo("clava",1)),this.labirintoBuilder.getStanze().get("mensa").getPersonaggio());
	}
	
	
	@Test
	public void testListaStanze_addMago() {
		Labirinto labirinto=labirintoBuilder
				.addStanzaIniziale("atrio")
				.addStanzaVincente("biblioteca")
				.addStanza("mensa").addMago("Mago","faccio magie","clava",1)
				.addStanza("corridoio")
				...
				.addStanza("Aula 1")
				.getLabirinto();
		assertEquals("Mago",this.labirintoBuilder.getStanze().get("mensa").getPersonaggio().getNome());
	}
	...
	public void testMonolocaleConAttrezzoSingoloDuplicato() {
		...
		assertEquals(Arrays.asList(spada),monolocale.getStanzaIniziale().getAttrezzi());
	}
	...
	public void testPiuDiQuattroAdiacenti() {
		...
		assertEquals(mappa,new HashMap<>(maze.getStanzaIniziale().getMapStanzeAdiacenti()));
	}
	...
	public void testAggiuntaAttrezzoAStanze_AppenaAggiunteMultiple() {
		...
		assertEquals(attrezzo,attrezzi.iterator().next());
	}
